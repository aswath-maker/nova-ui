...
The cat:
    - stays on top
    - breathes gently
    - follows the mouse with its eyes
    - can be moved
    - can be resized
    - launches Nova GUI
"""
...
class CatWindow:
    ...
    def _update_eyes(self):
        ...
        # The generated cat image already contains the eyes.
        #
        # We intentionally do not paint over the source artwork.
        #
        # The cursor-following effect is implemented as a tiny overlay
        # pupil that sits on the existing eye region.
        #
        # For a user-supplied pixel-art sprite, exact eye coordinates vary,
        # so use normalized positions appropriate to the supplied image.
        ...
        # Approximate eye centers for the supplied orange pixel cat.
        left_x = width * 0.43
        right_x = width * 0.62
